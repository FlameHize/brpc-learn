...
void Controller::IssueRPC(int64_t start_realtime_us) {
    ...
    // Establish a temporary socket and set the remote address and connection type 
    // according to the server selection policy
    ...
    // Make request --Call the corresponding protocol packaging
    butil::IOBuf packet;
    ...
    // Call Socket write function to send data
